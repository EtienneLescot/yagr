...
In V1, Yagr uses n8n as its execution backend through the existing n8n-as-code foundation. In V2, the same product surface can target a native Yagr engine. The user story stays the same: describe the automation you want, then let Yagr build, inspect, evolve, and operate it.
