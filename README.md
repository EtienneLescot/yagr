...
<td align="center" width="180">
	<img src="res/holon-logo.png" alt="Holon logo" width="140">
</td>
<td align="left">
...
[![Holon Docs](https://img.shields.io/badge/docs-holon-black?logo=gitbook)](https://n8nascode.dev/holon/docs/)
[![n8n backend](https://img.shields.io/badge/backend-n8n-FE5A16?logo=n8n&logoColor=white)](https://n8n.io/)
[![License: Apache-2.0](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://www.apache.org/licenses/LICENSE-2.0)

<br>

**Holon is the product layer.** It takes natural-language intent and turns it into live automations.

**n8n is the V1 execution engine.** Holon uses the n8n-as-code stack as its bridge today, while keeping the product story stable for a future native Holon engine.

[**Read Holon docs**](https://n8nascode.dev/holon/docs/) · [**Open n8n-as-code**](https://n8nascode.dev/n8n-as-code/) · [**Workflow GitOps docs**](https://n8nascode.dev/docs/)
...
Holon takes a radically different approach.

Holon is a general-purpose autonomous agent, but its execution layer is grounded in deterministic workflows.

When you ask Holon to sort your emails, draft replies, monitor Stripe churn, or automate an operations loop, it should not disappear into a temporary Python script that nobody can inspect tomorrow.

Instead, Holon dynamically architects, validates, and deploys a real workflow underneath the conversation.

That means Holon is an **automation agent** where:

- you express intent in natural language
- Holon plans against a grounded node ecosystem
- Holon generates and validates a workflow on a deterministic execution backend
- the resulting workflow becomes durable, executable memory and muscle that Holon can revisit later
...
Holon starts from what you want to automate, not from manually wiring implementation primitives.
...
Generated workflows are not throwaway output. They are persisted intent that Holon can inspect, explain, modify, and extend.
...
Holon stays above the execution engine. Today that engine is n8n. Tomorrow it can be a native Holon runtime.
...
The repository dev scripts intentionally use `.holon-test-workspace` so local development does not pollute your real Holon home.
...
Holon stores that state in its own home so the product does not depend on whatever repo or shell happens to be open.

---

## Product Philosophy

- **Holon is the agent.** n8n is the V1 execution backend.
...
- **The backend must stay swappable.** Moving from n8n to a native Holon engine should be an engine change, not a product rewrite.
...
|---|---|---|
| **Holon** | Autonomous automation agent | [Holon docs](https://n8nascode.dev/holon/docs/) |
...
- [Holon overview](https://n8nascode.dev/holon/docs/)
- [Holon getting started](https://n8nascode.dev/holon/docs/getting-started/)
