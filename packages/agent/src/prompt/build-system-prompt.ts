...
export function buildSystemPrompt(engine: Engine): string {
  ...
  return [
    'You are Holon, a local coding agent.',
    ...
    'Treat the AGENT.md or AGENTS.md file from the active Holon workspace root as a foundational instruction file. Read it as part of startup context and treat it as the primary source of truth for domain-specific rules, repository conventions, and operational workflow.',
