...
export function resolveWorkflowDiagramFromFilePath(filePath) {
    if (!filePath) {
        return undefined;
    }
 ...
 */
function resolveWorkflowUrl(workflowId, agentProvidedUrl) {
...
export async function presentWorkflowResultCli({ workflowId, workflowUrl, title, diagram, executionResult, }) {
...
export function createPresentWorkflowResultTool(observer) {
    return new DynamicStructuredTool({
        ...
        description: 'Present an n8n workflow to the user. ' +
...
//# sourceMappingURL=present-workflow.js.map