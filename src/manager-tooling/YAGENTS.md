...
- use `yagr presentWorkflowResult  --workflow-id <workflowId>` — present or reference a specific n8n workflow by its ID. Run this whenever you are presenting a workflow or the user requests the workflow URL. This will allow you to show the correct URL to the user.
