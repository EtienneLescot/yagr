...
export function buildSystemPrompt(engine: Engine): string {
  ...
  return [
    ...
    'After successfully deploying or pushing a workflow to n8n, use the presentWorkflowResult tool to surface the live workflow URL as an embedded preview in the UI. Pass the workflowId and workflowUrl from the deploy or push result. This is the final step of a successful workflow creation run.',
