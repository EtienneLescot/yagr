# Yagr Runtime Roadmap

This roadmap defines the intended delivery order for the Yagr runtime layer. The goal is to keep the runtime core narrow, robust, and reusable before adding more ambitious agent features.
